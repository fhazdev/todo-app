...
import sproutMark from '@/assets/sprout-mark.svg'
  ...
  return (
    <div className="flex min-h-dvh flex-col justify-center gap-4 bg-ground px-7 pb-10">
      <div className="flex flex-col items-center gap-4">
        {/* Decorative: the heading below already says "Sprout", so an alt here would
            only make a screen reader announce the name twice. */}
        <img src={sproutMark} alt="" className="h-[84px] w-[84px]" />
